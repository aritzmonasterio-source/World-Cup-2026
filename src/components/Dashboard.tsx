...
import { AlertCircle, CalendarCheck, CheckCircle2, ChevronRight, EyeOff, Info, Lock, Medal, Sparkles, Target, Trophy, UserCheck } from 'lucide-react';
    ...
    <div className="space-y-10">
      {showTutorial && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-6">
          <div className="dimension-card-accent max-w-2xl w-full p-8">
            <div className="flex items-start justify-between gap-6 mb-8">
              <div>
                ...
                <h2 className="text-3xl font-black uppercase tracking-tighter italic">Empieza en 4 pasos</h2>
              </div>
              <button onClick={closeTutorial} className="text-brand-zinc-500 hover:text-white text-xs font-black uppercase tracking-widest">
                Cerrar
              </button>
            </div>
...
function TutorialStep({ n, title, text }: { n: string; title: string; text: string }) {
  return (
    <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-5">
      <div className="w-8 h-8 rounded-lg bg-brand-gold text-black flex items-center justify-center font-black mb-4">{n}</div>
